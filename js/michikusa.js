...
function aux_write_stack_trace_21151(f_21153) {
	...
	var result_21154 = [null];
		...
		L6: do {
			var j_21421 = 0;
			var colontmp__201321 = 0;
			colontmp__201321 = (i_21164 - 1);
			var res_201326 = colontmp__201321;
			L7: do {
					L8: while (true) {
					if (!(0 <= res_201326)) break L8;
						j_21421 = res_201326;
...
function wrap_event_189392(d_189394, n_189395, k_189396, action_189397) {
					...
					function HEX3Aanonymous_189833(ev_189835) {
							...
							function wrapper_189836() {
								...
								framePtr = F;
									...
									F.line = 74;
									failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(74, 10) `action != nil` "));
									}
	...
	framePtr = F;
		...
		default: 
			...
			F.line = 115;
			d_189394.addEventListener(to_event_name_168695[chckIndx(k_189396, 0, (to_event_name_168695 != null ? to_event_name_168695.length : 0)+0-1)-0], result_189398, false);
			break;
		}
	framePtr = F.prev;
...
function apply_events_190086(n_190088) {
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_190102 = 0;
			F.line = 2737;
			var colontmp__201371 = 0;
			F.line = 128;
			colontmp__201371 = (n_190088.events != null ? n_190088.events.length : 0);
			F.line = 2739;
			var i_201372 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_201372 < colontmp__201371)) break L3;
						F.line = 128;
						i_190102 = i_201372;
						F.line = 129;
						n_190088.events[chckIndx(i_190102, 0, (n_190088.events != null ? n_190088.events.length : 0)+0-1)-0]["Field2"] = wrap_event_189392(dest_190089, n_190088, n_190088.events[chckIndx(i_190102, 0, (n_190088.events != null ? n_190088.events.length : 0)+0-1)-0]["Field0"], n_190088.events[chckIndx(i_190102, 0, (n_190088.events != null ? n_190088.events.length : 0)+0-1)-0]["Field1"]);
						F.line = 2742;
						i_201372 = addInt(i_201372, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function apply_style_58025(n_58027, s_58028) {
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_58221 = 0;
			F.line = 2672;
			var colontmp__201383 = 0;
			F.line = 300;
			colontmp__201383 = subInt(s_58028.length, 1);
			F.line = 2689;
			var res_201384 = 0;
			L2: do {
				F.line = 2690;
					L3: while (true) {
					if (!(res_201384 <= colontmp__201383)) break L3;
						F.line = 300;
						i_58221 = res_201384;
						F.line = 301;
						n_58027.style[s_58028[i_58221]] = s_58028[addInt(i_58221, 1)];
						F.line = 2692;
						res_201384 = addInt(res_201384, 2);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function to_dom_190167(n_190169, use_attached_node_190170, kxi_190171) {
	...
	BeforeRet: do {
		...
		F.line = 156;
		failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(156, 12) `result != nil` "));
		}
		...
		F.line = 163;
		failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(163, 12) `x.renderImpl != nil` "));
		}
		...
		if (!(!((x_190422.expanded == null)))) {
		F.line = 167;
		failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(167, 12) `x.expanded != nil` "));
		}
		...
		break BeforeRet;
			...
			F.line = 172;
			result_190172 = document.createElement(to_tag_168689[chckIndx(n_190169.kind, 0, (to_tag_168689 != null ? to_tag_168689.length : 0)+0-1)-0]);
			F.line = 123;
			n_190169.dom = result_190172;
			if (!((n_190169.id == null))) {
			F.line = 124;
			...
			L1: do {
				...
				L2: do {
					...
					var i_201341 = 0;
					F.line = 2737;
					var colontmp__201342 = 0;
					F.line = 282;
					colontmp__201342 = (n_190169.kids != null ? n_190169.kids.length : 0);
					F.line = 2739;
					var i_201343 = 0;
					L3: do {
						F.line = 2740;
							L4: while (true) {
							if (!(i_201343 < colontmp__201342)) break L4;
								F.line = 282;
								i_201341 = i_201343;
								F.line = 174;
								k_190831 = n_190169.kids[chckIndx(i_201341, 0, (n_190169.kids != null ? n_190169.kids.length : 0)+0-1)-0];
								F.line = 175;
								result_190172.appendChild(to_dom_190167(k_190831, use_attached_node_190170, kxi_190171));
								F.line = 2742;
								i_201343 = addInt(i_201343, 1);
							}
					} while(false);
				} while(false);
			} while(false);
		...
		L5: do {
			...
			L6: do {
				...
				var i_201354 = 0;
				F.line = 2672;
				var colontmp__201355 = 0;
				F.line = 285;
				colontmp__201355 = subInt((n_190169.attrs != null ? n_190169.attrs.length : 0), 2);
				F.line = 2689;
				var res_201356 = 0;
				L7: do {
					F.line = 2690;
						L8: while (true) {
						if (!(res_201356 <= colontmp__201355)) break L8;
							F.line = 285;
							i_201354 = res_201356;
							F.line = 185;
							k_190832 = n_190169.attrs[chckIndx(i_201354, 0, (n_190169.attrs != null ? n_190169.attrs.length : 0)+0-1)-0];
							F.line = 286;
							v_190833 = n_190169.attrs[chckIndx(addInt(i_201354, 1), 0, (n_190169.attrs != null ? n_190169.attrs.length : 0)+0-1)-0];
							if (!((v_190833 == null))) {
							F.line = 187;
							...
							F.line = 2692;
							res_201356 = addInt(res_201356, 2);
						}
				} while(false);
			} while(false);
		} while(false);
...
function HEX5BHEX5D_169750(x_169752, idx_169753) {
	...
	framePtr = F;
		F.line = 247;
		result_169754 = x_169752.kids[chckIndx(idx_169753, 0, (x_169752.kids != null ? x_169752.kids.length : 0)+0-1)-0];
	framePtr = F.prev;
...
function same_190920(n_190922, e_190923, nesting_190924) {
	...
	BeforeRet: do {
		...
		if ((to_tag_168689[chckIndx(n_190922.kind, 0, (to_tag_168689 != null ? to_tag_168689.length : 0)+0-1)-0] == e_190923.nodeName)) {
		F.line = 203;
		result_190926 = true;
		if (!((n_190922.kind == 0))) {
			if (!!((e_190923.childNodes.length == len_169728(n_190922)))) Tmp2 = false; else {				Tmp2 = !((n_190922.kind == 111));			}		if (Tmp2) {
		F.line = 207;
		rawEcho(makeNimstrLit("expected "), cstrToNimstr((len_169728(n_190922))+""), makeNimstrLit(" real "), cstrToNimstr((e_190923.childNodes.length)+""), makeNimstrLit(" "), cstrToNimstr(to_tag_168689[chckIndx(n_190922.kind, 0, (to_tag_168689 != null ? to_tag_168689.length : 0)+0-1)-0]), makeNimstrLit(" nesting "), cstrToNimstr((nesting_190924)+""));
		F.line = 208;
		result_190926 = false;
		break BeforeRet;
		}
		...
		L3: do {
			...
			var i_190994 = 0;
			F.line = 2737;
			var colontmp__201390 = 0;
			F.line = 209;
			colontmp__201390 = len_169728(n_190922);
			F.line = 2739;
			var i_201391 = 0;
			L4: do {
				F.line = 2740;
					L5: while (true) {
					if (!(i_201391 < colontmp__201390)) break L5;
						F.line = 209;
						i_190994 = i_201391;
			...
			F.line = 212;
		rawEcho(makeNimstrLit("VDOM: "), cstrToNimstr(to_tag_168689[chckIndx(n_190922.kind, 0, (to_tag_168689 != null ? to_tag_168689.length : 0)+0-1)-0]), makeNimstrLit(" DOM: "), cstrToNimstr(e_190923.nodeName));
		}
		}}}
	} while (false);
	framePtr = F.prev;
...
function eq_56814(a_56816, b_56817) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			var i_56916 = 0;
			F.line = 2737;
			var colontmp__201433 = 0;
			F.line = 233;
			colontmp__201433 = a_56816.length;
			F.line = 2739;
			var i_201434 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_201434 < colontmp__201433)) break L3;
						F.line = 233;
						i_56916 = i_201434;
...
function same_attrs_171480(a_171482, b_171483) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			var i_171507 = 0;
			F.line = 2737;
			var colontmp__201438 = 0;
			F.line = 291;
			colontmp__201438 = (a_171482.attrs != null ? a_171482.attrs.length : 0);
			F.line = 2739;
			var i_201439 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_201439 < colontmp__201438)) break L3;
						F.line = 291;
						i_171507 = i_201439;
						if (!((a_171482.attrs[chckIndx(i_171507, 0, (a_171482.attrs != null ? a_171482.attrs.length : 0)+0-1)-0] == b_171483.attrs[chckIndx(i_171507, 0, (b_171483.attrs != null ? b_171483.attrs.length : 0)+0-1)-0]))) {
						F.line = 292;
						result_171484 = false;
						break BeforeRet;
						}
...
function eq_191214(a_191216, b_191217, recursive_191218) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			var i_192014 = 0;
			F.line = 2737;
			var colontmp__201423 = 0;
			F.line = 254;
			colontmp__201423 = len_169728(a_191216);
			F.line = 2739;
			var i_201424 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_201424 < colontmp__201423)) break L3;
						F.line = 254;
						i_192014 = i_201424;
		...
		L6: do {
			...
			var i_192608 = 0;
			F.line = 2737;
			var colontmp__201428 = 0;
			F.line = 286;
			colontmp__201428 = len_169728(a_191216);
			F.line = 2739;
			var i_201429 = 0;
			L7: do {
				F.line = 2740;
					L8: while (true) {
					if (!(i_201429 < colontmp__201428)) break L8;
						F.line = 286;
						i_192608 = i_201429;
	...
	framePtr = F;
		...
		L1: do {
			...
			L2: do {
				...
				var i_201445 = 0;
				F.line = 2672;
				var colontmp__201446 = 0;
				F.line = 285;
				colontmp__201446 = subInt((old_node_192693.attrs != null ? old_node_192693.attrs.length : 0), 2);
				F.line = 2689;
				var res_201447 = 0;
				L3: do {
					F.line = 2690;
						L4: while (true) {
						if (!(res_201447 <= colontmp__201446)) break L4;
							F.line = 285;
							i_201445 = res_201447;
							F.line = 305;
							k_192702 = old_node_192693.attrs[chckIndx(i_201445, 0, (old_node_192693.attrs != null ? old_node_192693.attrs.length : 0)+0-1)-0];
							F.line = 286;
							__192703 = old_node_192693.attrs[chckIndx(addInt(i_201445, 1), 0, (old_node_192693.attrs != null ? old_node_192693.attrs.length : 0)+0-1)-0];
							F.line = 306;
							old_node_192693.dom.removeAttribute(k_192702);
							F.line = 2692;
							res_201447 = addInt(res_201447, 2);
						}
				} while(false);
			} while(false);
		} while(false);
		L5: do {
			...
			L6: do {
				...
				var i_201453 = 0;
				F.line = 2672;
				var colontmp__201454 = 0;
				F.line = 285;
				colontmp__201454 = subInt((new_node_192692.attrs != null ? new_node_192692.attrs.length : 0), 2);
				F.line = 2689;
				var res_201455 = 0;
				L7: do {
					F.line = 2690;
						L8: while (true) {
						if (!(res_201455 <= colontmp__201454)) break L8;
							F.line = 285;
							i_201453 = res_201455;
							F.line = 307;
							k_192704 = new_node_192692.attrs[chckIndx(i_201453, 0, (new_node_192692.attrs != null ? new_node_192692.attrs.length : 0)+0-1)-0];
							F.line = 286;
							v_192705 = new_node_192692.attrs[chckIndx(addInt(i_201453, 1), 0, (new_node_192692.attrs != null ? new_node_192692.attrs.length : 0)+0-1)-0];
							if (!((v_192705 == null))) {
							F.line = 309;
							...
							F.line = 2692;
							res_201455 = addInt(res_201455, 2);
						}
				} while(false);
			} while(false);
		} while(false);
...
function merge_events_192719(new_node_192721, old_node_192722, kxi_192723) {
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_192745 = 0;
			F.line = 2737;
			var colontmp__201460 = 0;
			F.line = 315;
			colontmp__201460 = (old_node_192722.events != null ? old_node_192722.events.length : 0);
			F.line = 2739;
			var i_201461 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_201461 < colontmp__201460)) break L3;
						F.line = 315;
						i_192745 = i_201461;
						F.line = 316;
						var k_192746 = old_node_192722.events[chckIndx(i_192745, 0, (old_node_192722.events != null ? old_node_192722.events.length : 0)+0-1)-0]["Field0"];
						F.line = 317;
						F.line = 317;
						switch (k_192746) {
						case 30:
						case 29:
							...
							break;
						default: 
							Tmp4 = to_event_name_168695[chckIndx(k_192746, 0, (to_event_name_168695 != null ? to_event_name_168695.length : 0)+0-1)-0];
							break;
						}
						var name_192749 = Tmp4;
						F.line = 320;
						d_192724.removeEventListener(name_192749, old_node_192722.events[chckIndx(i_192745, 0, (old_node_192722.events != null ? old_node_192722.events.length : 0)+0-1)-0]["Field2"]);
						F.line = 2742;
						i_201461 = addInt(i_201461, 1);
					}
			} while(false);
		} while(false);
		}
...
function add_patch_192814(kxi_192816, ka_192817, parenta_192818, currenta_192819, na_192820, old_node_192821) {
	...
	framePtr = F;
		...
		if (kxi_192816.patches != null) { kxi_192816.patches.push({k: ka_192817, parent: parenta_192818, current: currenta_192819, newNode: na_192820, oldNode: old_node_192821}); } else { kxi_192816.patches = [{k: ka_192817, parent: parenta_192818, current: currenta_192819, newNode: na_192820, oldNode: old_node_192821}]; };
			...
			F.line = 345;
			kxi_192816.patches[chckIndx(l_192822, 0, (kxi_192816.patches != null ? kxi_192816.patches.length : 0)+0-1)-0].k = ka_192817;
			F.line = 346;
			kxi_192816.patches[chckIndx(l_192822, 0, (kxi_192816.patches != null ? kxi_192816.patches.length : 0)+0-1)-0].parent = parenta_192818;
			F.line = 347;
			kxi_192816.patches[chckIndx(l_192822, 0, (kxi_192816.patches != null ? kxi_192816.patches.length : 0)+0-1)-0].current = currenta_192819;
			F.line = 348;
			kxi_192816.patches[chckIndx(l_192822, 0, (kxi_192816.patches != null ? kxi_192816.patches.length : 0)+0-1)-0].newNode = na_192820;
			F.line = 349;
			kxi_192816.patches[chckIndx(l_192822, 0, (kxi_192816.patches != null ? kxi_192816.patches.length : 0)+0-1)-0].oldNode = old_node_192821;
		}
...
function diff_193245(new_node_193247, old_node_193248, parent_193249, current_193250, kxi_193251) {
	...
	BeforeRet: do {
		...
		case 2:
			...
			F.line = 463;
			failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(463, 12) `oldNode.kind == newNode.kind` "));
			}
			...
			L7: do {
				...
				var i_193639 = 0;
				F.line = 2699;
				var colontmp__201398 = 0;
				F.line = 487;
				colontmp__201398 = subInt(pos_193633, 1);
				F.line = 2710;
				var res_201399 = common_prefix_193602;
				L8: do {
					F.line = 2711;
						L9: while (true) {
						if (!(res_201399 <= colontmp__201398)) break L9;
							F.line = 487;
							i_193639 = res_201399;
							F.line = 488;
							diff_193245(HEX5BHEX5D_169750(new_node_193247, i_193639), HEX5BHEX5D_169750(old_node_193248, i_193639), current_193250, current_193250.childNodes[chckIndx(i_193639, 0, (current_193250.childNodes != null ? current_193250.childNodes.length : 0)+0-1)-0], kxi_193251);
							F.line = 2713;
							res_201399 = addInt(res_201399, 1);
						}
				} while(false);
			} while(false);
			...
			L10: do {
				...
				F.line = 494;
				var before_193646 = current_193250.childNodes[chckIndx(addInt(old_pos_193614, 1), 0, (current_193250.childNodes != null ? current_193250.childNodes.length : 0)+0-1)-0];
				L13: do {
					F.line = 495;
					var i_193652 = 0;
					F.line = 2710;
					var res_201411 = pos_193633;
					L14: do {
						F.line = 2711;
							L15: while (true) {
							if (!(res_201411 <= new_pos_193615)) break L15;
								F.line = 495;
								i_193652 = res_201411;
								F.line = 496;
								add_patch_192814(kxi_193251, 3, current_193250, before_193646, HEX5BHEX5D_169750(new_node_193247, i_193652), null);
								F.line = 2713;
								res_201411 = addInt(res_201411, 1);
							}
					} while(false);
				} while(false);
			}
			...
			L16: do {
				...
				var i_193658 = 0;
				F.line = 2710;
				var res_201417 = pos_193633;
				L17: do {
					F.line = 2711;
						L18: while (true) {
						if (!(res_201417 <= old_pos_193614)) break L18;
							F.line = 498;
							i_193658 = res_201417;
							F.line = 499;
							add_patch_192814(kxi_189326[0], 4, null, null, null, HEX5BHEX5D_169750(old_node_193248, i_193658));
							F.line = 501;
							add_patch_192814(kxi_193251, 1, current_193250, current_193250.childNodes[chckIndx(i_193658, 0, (current_193250.childNodes != null ? current_193250.childNodes.length : 0)+0-1)-0], null, null);
							F.line = 2713;
							res_201417 = addInt(res_201417, 1);
						}
				} while(false);
			} while(false);
			break;
		...
		case 4:
			if (true) {
			F.line = 505;
			failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(505, 26) `false` eq returned usenewNode"));
			}
		...
		L1: do {
			F.line = 516;
				...
				if (!(i_194018 < (kxi_194016.components != null ? kxi_194016.components.length : 0))) break L2;
					F.line = 517;
					var x_194024 = kxi_194016.components[chckIndx(i_194018, 0, (kxi_194016.components != null ? kxi_194016.components.length : 0)+0-1)-0].oldNode;
					F.line = 518;
					var new_node_194025 = kxi_194016.components[chckIndx(i_194018, 0, (kxi_194016.components != null ? kxi_194016.components.length : 0)+0-1)-0].newNode;
						if (!!((x_194024.changedImpl == null))) Tmp3 = false; else {							Tmp3 = x_194024.changedImpl(x_194024, new_node_194025);						}					if (Tmp3) {
					F.line = 524;
					var current_194401 = kxi_194016.components[chckIndx(i_194018, 0, (kxi_194016.components != null ? kxi_194016.components.length : 0)+0-1)-0].current;
					F.line = 525;
					var parent_194402 = kxi_194016.components[chckIndx(i_194018, 0, (kxi_194016.components != null ? kxi_194016.components.length : 0)+0-1)-0].parent;
					F.line = 526;
...
function move_dom_192907(dest_192909, src_192910) {
	...
	framePtr = F;
		...
		F.line = 366;
		failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(366, 10) `dest.len == src.len` "));
		}
		...
		L1: do {
			...
			var i_193008 = 0;
			F.line = 2737;
			var colontmp__201477 = 0;
			F.line = 367;
			colontmp__201477 = len_169728(dest_192909);
			F.line = 2739;
			var i_201478 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_201478 < colontmp__201477)) break L3;
						F.line = 367;
						i_193008 = i_201478;
						F.line = 368;
						move_dom_192907(HEX5BHEX5D_169750(dest_192909, i_193008), HEX5BHEX5D_169750(src_192910, i_193008));
						F.line = 2742;
						i_201478 = addInt(i_201478, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function HEX5BHEX5DHEX3D_169768(x_169770, idx_169771, y_169772) {
	...
	framePtr = F;
		F.line = 248;
		x_169770.kids[chckIndx(idx_169771, 0, (x_169770.kids != null ? x_169770.kids.length : 0)+0-1)-0] = y_169772;
	framePtr = F.prev;
...
function apply_patch_193022(kxi_193024) {
	...
	framePtr = F;
		L1: do {
			...
			var i_193032 = 0;
			F.line = 2737;
			var colontmp__201467 = 0;
			F.line = 371;
			colontmp__201467 = kxi_193024.patchLen;
			F.line = 2739;
			var i_201468 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_201468 < colontmp__201467)) break L3;
						F.line = 371;
						i_193032 = i_201468;
						F.line = 372;
						var p_193033 = nimCopy(null, kxi_193024.patches[chckIndx(i_193032, 0, (kxi_193024.patches != null ? kxi_193024.patches.length : 0)+0-1)-0], NTI189209);
						F.line = 373;
						switch (p_193033.k) {
						case 0:
							F.line = 375;
		...
		L4: do {
			...
			var i_193083 = 0;
			F.line = 2737;
			var colontmp__201472 = 0;
			F.line = 402;
			colontmp__201472 = kxi_193024.patchLenV;
			F.line = 2739;
			var i_201473 = 0;
			L5: do {
				F.line = 2740;
					L6: while (true) {
					if (!(i_201473 < colontmp__201472)) break L6;
						F.line = 402;
						i_193083 = i_201473;
						F.line = 403;
						var p_193084 = nimCopy(null, kxi_193024.patchesV[chckIndx(i_193083, 0, (kxi_193024.patchesV != null ? kxi_193024.patchesV.length : 0)+0-1)-0], NTI189211);
						F.line = 404;
						HEX5BHEX5DHEX3D_169768(p_193084.parent, p_193084.pos, p_193084.newChild);
						if (!(!((p_193084.newChild.dom == null)))) {
						F.line = 405;
						failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(405, 12) `p.newChild.dom != nil` "));
						}
						
						F.line = 2742;
						i_201473 = addInt(i_201473, 1);
					}
			} while(false);
		} while(false);
		F.line = 406;
...
function dodraw_196062(kxi_196064) {
	...
	BeforeRet: do {
		...
		replace_by_id_191012(kxi_196064.rootId, asdom_196085);
			...
			F.line = 620;
			failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(620, 14) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
			}
		...
		if (!(same_190920(kxi_196064.currentTree, document.getElementById(kxi_196064.rootId), 0))) {
		F.line = 633;
		failed_assert_impl_15266(makeNimstrLit("/var/www/html/iranika.github.io/mo-code/js/karax/karax/karax.nim(633, 12) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
		}
	...
	framePtr = F;
		...
		L1: do {
			...
			L2: do {
				F.line = 4;
					L3: while (true) {
					if (!(i_201484 < (kids_171050 != null ? kids_171050.length : 0))) break L3;
						F.line = 263;
						k_171082 = kids_171050[chckIndx(i_201484, 0, (kids_171050 != null ? kids_171050.length : 0)+0-1)-0];
						F.line = 263;
						add_169786(result_171051, k_171082);
						F.line = 6;
						i_201484 = addInt(i_201484, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function modal_201031() {
	var result_201033 = null;

	var F={procname:"michikusa.modal",prev:framePtr,filename:"michikusa.nim",line:0};
	framePtr = F;
		F.line = 6;
		F.line = 6;
		var tmp_201076 = tree_171046(43, []);
		F.line = 7;
		add_169786(tmp_201076, text_171164(makeNimstrLit("return modal block")));
		result_201033 = tmp_201076;
	framePtr = F.prev;

	return result_201033;

}

function right_sidebar_201098() {
	var result_201100 = null;

	var F={procname:"michikusa.rightSidebar",prev:framePtr,filename:"michikusa.nim",line:0};
	framePtr = F;
		F.line = 10;
		F.line = 10;
		var tmp_201101 = tree_171046(43, []);
		F.line = 11;
		add_169786(tmp_201101, text_171164(makeNimstrLit("return Right var")));
		result_201100 = tmp_201101;
	framePtr = F.prev;

	return result_201100;

}

function text_171201(s_171203) {
	var result_171204 = null;

	var F={procname:"vdom.text",prev:framePtr,filename:"vdom.nim",line:0};
	framePtr = F;
		F.line = 272;
		result_171204 = {kind: 0, text: s_171203, index: -1, m_type: NTI168714, id: null, class: null, kids: null, attrs: null, events: null, style: null, dom: null};
	framePtr = F.prev;

	return result_171204;
...
function view_201119() {

		function HEX3Aanonymous_201224(ev_201226, n_201227) {
			var F={procname:"view.:anonymous",prev:framePtr,filename:"michikusa.nim",line:0};
			framePtr = F;
				F.line = 21;
				if (lines_201017[0] != null) { lines_201017[0].push("Add image"); } else { lines_201017[0] = ["Add image"]; };
			framePtr = F.prev;

			
		}

	var result_201121 = null;

	var F={procname:"michikusa.view",prev:framePtr,filename:"michikusa.nim",line:0};
	framePtr = F;
		F.line = 14;
		F.line = 14;
		var tmp_201122 = tree_171046(43, []);
		L1: do {
			F.line = 15;
			var x_201214 = null;
			F.line = 184;
			var i_201494 = 0;
			F.line = 185;
			var l_201495 = (lines_201017[0] != null ? lines_201017[0].length : 0);
			L2: do {
				F.line = 186;
					L3: while (true) {
					if (!(i_201494 < l_201495)) break L3;
						F.line = 15;
						x_201214 = lines_201017[0][chckIndx(i_201494, 0, (lines_201017[0] != null ? lines_201017[0].length : 0)+0-1)-0];
						F.line = 16;
						var tmp_201123 = tree_171046(43, []);
						F.line = 17;
						add_169786(tmp_201123, text_171201(x_201214));
						F.line = 17;
						add_169786(tmp_201122, tmp_201123);
						F.line = 188;
						i_201494 = addInt(i_201494, 1);
						if (!(((lines_201017[0] != null ? lines_201017[0].length : 0) == l_201495))) {
						F.line = 189;
						failed_assert_impl_15266(makeNimstrLit("/root/.choosenim/toolchains/nim-1.0.4/lib/system/iterators.nim(189, 11) `len(a) == L` the length of the seq changed while iterating over it"));
						}
		...
		F.line = 18;
		var tmp_201124 = tree_171046(106, []);
		F.line = 19;
		add_169786(tmp_201124, text_171164(makeNimstrLit("\xE7\xB6\x9A\xE3\x81\x8D\xE3\x82\x92\xE8\xA1\xA8\xE7\xA4\xBA")));
		F.line = 20;
		add_event_handler_197948(tmp_201124, 0, HEX3Aanonymous_201224, kxi_189326[0]);
		F.line = 20;
		add_169786(tmp_201122, tmp_201124);
		result_201121 = tmp_201122;
	framePtr = F.prev;

	return result_201121;

}

function tfooter_201262() {
	var result_201264 = null;

	var F={procname:"michikusa.tfooter",prev:framePtr,filename:"michikusa.nim",line:0};
	framePtr = F;
		F.line = 24;
		F.line = 24;
		var tmp_201265 = tree_171046(43, []);
		F.line = 25;
		add_169786(tmp_201265, text_171164(makeNimstrLit("return footer")));
		result_201264 = tmp_201265;
	framePtr = F.prev;

	return result_201264;

}

function create_dom_201283() {
	var result_201285 = null;

	var F={procname:"michikusa.createDom",prev:framePtr,filename:"michikusa.nim",line:0};
	framePtr = F;
		F.line = 28;
		F.line = 28;
		var tmp_201286 = tree_171046(43, []);
		F.line = 29;
		add_169786(tmp_201286, modal_201031());
		F.line = 30;
		add_169786(tmp_201286, right_sidebar_201098());
		F.line = 31;
		add_169786(tmp_201286, view_201119());
		F.line = 32;
		add_169786(tmp_201286, tfooter_201262());
		result_201285 = tmp_201286;
	framePtr = F.prev;

	return result_201285;

}
set_renderer_197801(create_dom_201283, "ROOT", null);
